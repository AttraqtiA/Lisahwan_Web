...
@section('content_page')
    <section style="background-image: url('/images/cover.jpg')"
        ...
        <div class="px-4 mx-auto max-w-screen-xl text-center text-white py-16 lg:py-24 flex flex-col gap-16">
            <div>
                <h2 class="text-center mb-4 text-4xl font-bold">Segera Dapatkan <mark
            ...
            <div class="flex flex-col md:flex-row justify-evenly gap-8 md:gap-0">
                <a href="https://api.whatsapp.com/send?phone=6282230308030" target="_blank" class="m-auto">
                    <button type="button" data-te-ripple-init data-te-ripple-color="light"
                        class="py-4 flex items-center mb-2 inline-block rounded-xl px-6 py-2.5 text-xs font-medium leading-normal text-white shadow-md transition duration-150 ease-in-out hover:shadow-lg focus:shadow-lg focus:outline-none focus:ring-0 active:shadow-lg"
                        style="background-color: #128c7e">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 md:h-9 md:w-9" fill="currentColor"
                            viewBox="0 0 24 24">
                            <path
                        ...
                        <p class="ml-5 text-xl md:text-2xl">Admin</p>
                    </button>
                </a>
                ...
                <a href="https://www.instagram.com/lisahwan" target="_blank" class="m-auto">
                    <button type="button" data-te-ripple-init data-te-ripple-color="light"
                        ...
                        <p class="ml-5 text-xl md:text-2xl">lisahwan</p>
                ...
                <a href="https://www.tokopedia.com/lisahwan" target="_blank" class="m-auto">
                    <button type="button" data-te-ripple-init data-te-ripple-color="light"
                        class="py-4 flex items-center mb-2 inline-block rounded-xl px-6 md:py-2.5 text-xs font-medium leading-normal text-white shadow-md transition duration-150 ease-in-out hover:shadow-lg focus:shadow-lg focus:outline-none focus:ring-0 active:shadow-lg"
                        style="background-color: #41b549">
                        <img src="/images/tokopedia_logo.png" class="w-6 md:w-10" alt="Tokopedia">
                        <p class="ml-5 text-xl md:text-2xl">lisahwan</p>
                    </button>
                </a>
            ...
            <iframe class="mx-auto px-4 w-full md:w-3/4 shadow-lg"
