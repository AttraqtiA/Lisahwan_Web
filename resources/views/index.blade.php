...
@section('meta_seo')
    ...
    <meta name="description"
        content="Lisahwan, toko online resmi untuk Spikoe, lauk kering, dan oleh-oleh Surabaya dengan kualitas premium. Temukan pilihan oleh-oleh Surabaya dari Lisahwan.">
    <meta name="keywords"
        content="Lisahwan, spikoe surabaya, oleh-oleh surabaya, lauk kering surabaya, camilan khas surabaya, kue lapis surabaya, sambal nusantara">

    <!-- Open Graph (WhatsApp, Facebook, IG Preview) -->
    <meta property="og:title" content="Lisahwan - Oleh-oleh Surabaya">
    <meta property="og:description"
        content="Toko online resmi Lisahwan. Pusat belanja Spikoe, lauk kering, dan oleh-oleh Surabaya terbaik. Pesan langsung di sini!">
      ...
      "@graph": [
        {
          ...
          "description": "Toko online resmi Lisahwan. Pusat belanja Spikoe, lauk kering, dan oleh-oleh Surabaya."
        },
        {
          "@type": "WebSite",
          "name": "Lisahwan",
                                ...
                                <a href="{{ route('member.products.show', $bestseller->product->id) }}"
                                    ...
                                    <div class="px-4 pt-4 flex flex-col flex-grow">
                                        ...
                                        <p class="text-xs sm:text-sm font-medium text-gray-900 text-center mt-2">Terjual
                                            {{ $bestseller->product->order_detail->sum('quantity') }}</p>
                                    </div>
                                </a>
