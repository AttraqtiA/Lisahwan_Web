<nav class="bg-white dark:bg-gray-900 w-full z-20 top-0 left-0 border-b border-black dark:border-black">
    <div class="flex flex-wrap items-center justify-between mx-auto py-4 px-4 md:px-8">
        ...
        <div class="flex md:order-2">
            ...
            <ul class="flex flex-row gap-2 md:gap-4 mt-1 md:mt-0">
                <li>
                    <a href="/cart" class="">
        ...
        <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-sticky">
            <ul
                ...
                <li>
                    <a href="/products"
                        class="block py-2 pl-3 pr-4 {{ $active_2 ?? 'text-black rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-yellow-500 md:p-0 md:dark:hover:text-yellow-500 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700' }}"
