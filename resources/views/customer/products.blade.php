                ...
                <div data-aos="fade-up" data-aos-anchor-placement="top-bottom" data-aos-duration="800"
                    ...
                    <div class="p-4 flex flex-col flex-grow">
                        ...
                        <div class="flex flex-row w-full justify-center items-center">
                            ...
                            @else
                                <p class="text-base sm:text-sm md:text-lg lg:text-base font-normal text-white text-center">
                                    Rp.
                                    {{ number_format($product->price, 0, ',', '.') }}</p>
                            @endif
                        </div>
                        ...
                        <div class="text-right">
                            <form action="{{ route('member.wishlist.store', $product->id) }}" method="POST"
                                ...
                                @guest
                                    <button type="submit">
                                        <svg class="cursor-pointer w-6 h-6 text-white hover:text-red-600" aria-hidden="true"
