...
@section('content_page')
    <div class="grid grid-cols-1 sm:grid-cols-1 lg:grid-cols-2 gap-x-10 gap-y-8 sm:gap-y-8 lg:gap-y-12 p-8 sm:p-12 mx-auto">
        <div class="flex flex-col mx-auto w-full">
            @error('payment_upload')
                <p class="mb-2 w-full text-center text-base text-red-600 dark:text-red-500"><span
                        class="font-medium">{{ $message }}
                </p>
            @enderror
            <h1 class="mb-5 text-xl sm:text-2xl lg:text-3xl font-bold text-gray-900">Detail Pengiriman</h1>
            <form action="/checkout/payment" method="POST" enctype="multipart/form-data">
                @csrf
            ...
            <div class="flex flex-col col-span-2 mt-12">
                <div class="flex flex-row justify-between items-center">
                    <h1 class="text-xl sm:text-2xl lg:text-3xl font-bold dark:text-gray-900">Produk Lainnya</h1>
                    <a href="/products">
