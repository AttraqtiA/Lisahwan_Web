<div id="order-detail{{ $order->id }}"
    ...
    <h5 id="drawer-label"
        class="pl-4 inline-flex items-center mb-4 text-base font-semibold text-gray-500 dark:text-gray-400">
    ...
    <div
        class="md:px-4 flex flex-col bg-white justify-center border border-gray-300 drop-shadow-md">
                    ...
                    <div class="flex flex-row justify-between items-center">
                        ...
                        <span
                            class="ml-8 inline-flex justify-center items-center bg-yellow-100 text-yellow-800 text-sm font-medium px-3 py-1.5 rounded border border-yellow-500"><svg
                                class="w-3 h-3 mr-1 text-yellow-800 dark:text-yellow-800"
