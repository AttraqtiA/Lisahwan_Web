                                    ...
                                    <div id="update-modal{{ $order->id }}" tabindex="-1" aria-hidden="true"
                                        ...
                                        <div class="relative p-4 w-full max-w-3xl h-full md:h-auto">
                                            ...
                                            <div id="update-modal-content"
                                                ...
                                                <form id="update-form"
                                                    action="@if (Auth::user()->isOwner()) {{ route('owner.order_history.update', $order) }}                                                 @elseif (Auth::user()->isAdmin())
                                                        @elseif (Auth::user()->isAdmin()) {{ route('admin.order_history.update', $order) }} @endif"
