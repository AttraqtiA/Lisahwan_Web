            ...
            <section style="background-image: url('/images/fotoproduk/GalleryCarousel_13.jpeg')"
                ...
                <div class="flex flex-col items-center justify-center p-8 mx-auto md:h-full lg:py-0">
                    <div data-aos="fade-up" data-aos-anchor-placement="top-bottom" data-aos-duration="800"
                        class="m-4 md:m-16 w-full rounded-lg shadow sm:max-w-md xl:p-0 bg-gray-900">
                        <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                            ...
                            <form method="POST" action="{{ route('register') }}" class="space-y-4 md:space-y-6"
                                ...
                                <div class="flex flex-row gap-4">
                                    <div>
                                        <label data-aos="fade-up" data-aos-anchor-placement="top-bottom"
                                            data-aos-duration="800" for="name"
                                            class="block mb-2 text-sm font-medium text-white">Nama</label>
                                        <input data-aos="fade-up" data-aos-anchor-placement="top-bottom"
                                            data-aos-duration="800" type="text" name="name" id="name"
                                    ...
                                    <div>
                                        <label data-aos="fade-up" data-aos-anchor-placement="top-bottom"
                                            data-aos-duration="800" for="phone_number"
                                            class="block mb-2 text-sm font-medium text-white">No.
                                            Telp/WA</label>
                                        <input data-aos="fade-up" data-aos-anchor-placement="top-bottom"
                                            data-aos-duration="800" type="text" name="phone_number" id="phone_number"
                                ...
                                <div>
                                    ...
                                    <div data-aos="fade-up" data-aos-anchor-placement="top-bottom" data-aos-duration="800"
                                        ...
                                        <input type="password" name="password" id="password"
                                            ...
                                            class="{{ $errors->has('password') ? 'bg-red-100 border-red-400 text-red-500 placeholder-red-700 focus:ring-red-500 focus:border-red-500' : 'bg-white border-yellow-500 text-gray-900 placeholder-gray-400  focus:ring-yellow-500 focus:border-yellow-500' }} rounded-lg border-2 text-sm mt-3 block w-full p-2.5"
